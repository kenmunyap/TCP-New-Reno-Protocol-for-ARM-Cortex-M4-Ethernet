...
void xtest_TxTCPSM_for_fast_recovery_start_from_begining_with_offset_0_and_congestion_window_size_50_for_dupack_case(void){
  Cwnd Window;
...
void xtest_TxTCPSM_for_fast_recovery_start_from_begining_with_offset_0_and_congestion_window_size_50_for_non_dupack_case(void){
  Cwnd Window;
  cwndInitWindow(&Window);
  TCP_state state;
  initTCPState(&state);
